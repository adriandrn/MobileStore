            ...
            <div class="card">
               <div class="card-body">
                  <div class="col-12 grid-margin stretch-card">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="card-title">Editar de tipo de Gama</h4>
                           <p class="card-description">
                              Editar registro gamas
                           </p>
                           <form action="" method="POST" class="forms-sample">
                              <input type="hidden" name="id_usuario" value="">
                              <div class="form-group">
                                 <label for="gama">Tipo de Gama</label>
                                 <input name="ap_paterno" value="" type="text" class="form-control" id="app" placeholder="Introduzca la gama">
                              </div>
